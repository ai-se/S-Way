...
r1 = ax1.bar(index, get_data("NSGAII", "spread"), bar_width,alpha=opacity,color='#247BA0',error_kw=error_config, hatch="o")
r2 = ax1.bar(index+bar_width, get_data("SPEA2", "spread"), bar_width,alpha=opacity,color='#70C1B3',error_kw=error_config, hatch='*')
r3 = ax1.bar(index + 2*bar_width, get_data("GALE", "spread"), bar_width,alpha=opacity,color='#B2DBBF',error_kw=error_config, hatch='0')
r4 = ax1.bar(index + 3*bar_width, get_data("GALE_NM", "spread"), bar_width,alpha=opacity,color='#F3FFBD',error_kw=error_config, hatch='+')
r5 = ax1.bar(index + 4*bar_width, get_data("GALE_LP", "spread"), bar_width,alpha=opacity,color='#FF1654',error_kw=error_config, hatch='x')
...
ax1.text(0.5, 0.95*(bottom+top), 'Spread',
...
plt.tight_layout()
# plt.show()
plt.savefig('spread.eps', format='eps')