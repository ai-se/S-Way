...
r6 = ax1.bar(index + 2*bar_width, get_data("GALE_LPI", "evals"), bar_width,alpha=opacity,color='#00D9FA',error_kw=error_config)
ax1.set_yscale('log')
# ax1.set_ylim(0, 119)
...
plt.figlegend([r1, r2, r6], ["NSGAII", "SPEA2", "SWAY"], frameon=False, loc='upper center', bbox_to_anchor=(0.5, 1.013), fancybox=True, ncol=6, prop={'size':15})
...
plt.tight_layout()
# plt.show()
plt.savefig('prelims_eval.eps', format='eps')