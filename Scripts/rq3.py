...
r5 = ax1.bar(index + 4*bar_width, get_data("GALE_LP", "hv"), bar_width,alpha=opacity,color='#FA5705',error_kw=error_config)
r6 = ax1.bar(index + 5*bar_width, get_data("GALE_LP_I", "hv"), bar_width,alpha=opacity,color='black',error_kw=error_config)
# ax1.set_xlim(5, 190)
# ax1.set_ylim(0, 119)
...
r5 = ax2.bar(index + 4*bar_width, get_data("GALE_LP", "spread"), bar_width,alpha=opacity,color='#FA5705',error_kw=error_config)
r6 = ax2.bar(index + 5*bar_width, get_data("GALE_LP_I", "spread"), bar_width,alpha=opacity,color='black',error_kw=error_config)
ax2.set_xlim(10, 300)
...
ax2.set_xticks([41, 71, 101, 131, 161, 191, 221, 251, 281])
ax2.set_xticklabels(["POM3A", "POM3B", "POM3C", "POM3D", "X_ALL", "X_OSP", "X_O2", "X_G", "X_F"], rotation='vertical', fontsize='large')
ax2.tick_params(axis='y', labelsize=12)



plt.figlegend([r1, r2, r3, r4, r5, r6], ["NSGAII", "SPEA2", "GALE", "GALE-S-NM", "GALE-S-LP", "GALE-S-LP-I"], frameon=False, loc='upper center', bbox_to_anchor=(0.5, 1.023), fancybox=True, ncol=6)
...
plt.tight_layout()
# plt.show()
plt.savefig('rq3.eps', format='eps')